...
def main():
    ...
    # world.add(Map("assets/map_ugly3.png"))
    ...
    world.add(Nest(position = (226,216), spawn_rate=50, max_ants = 200))
    world.add(FoodCluster(position = (648,656), amount=200))
    world.add(FoodCluster(position = (1056,662), amount=400))
    world.add(FoodCluster(position = (1006,148), amount=600))
